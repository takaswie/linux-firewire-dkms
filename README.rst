...
::
    ...
    $ sudo ln -s $(pwd) /usr/src/linux-firewire-7.0
    $ sudo dkms install linux-firewire/7.0 --force
...
::
    ...
    $ sudo dkms remove linux-firewire/7.0 --all
    $ sudo rm /usr/share/dkms/modules_to_force_install/linux-firewire.conf
    $ sudo rm /usr/src/linux-firewire-7.0
